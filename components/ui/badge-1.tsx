...
const sizes = {
  xs: "text-[10px] h-4 px-1 tracking-[0.2px] gap-[2px]",
...
const Content = ({ icon, size, children }: Pick<BadgeProps, "icon" | "size" | "children">) => (
  <>
    <style>
      {`
          .xsIconContainer svg { width: 10px; height: 10px; }
          .smIconContainer svg { width: 11px; height: 11px; }
          .mdIconContainer svg { width: 14px; height: 14px; }
          .lgIconContainer svg { width: 16px; height: 16px; }
        `}
    </style>
